...
```typescript
import type { AllTimeRankedBoxerUpdateRequest } from ''
...
} satisfies AllTimeRankedBoxerUpdateRequest
...
const exampleParsed = JSON.parse(exampleJSON) as AllTimeRankedBoxerUpdateRequest
