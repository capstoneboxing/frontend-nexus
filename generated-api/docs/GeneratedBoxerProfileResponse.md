...
```typescript
import type { GeneratedBoxerProfileResponse } from ''
...
} satisfies GeneratedBoxerProfileResponse
...
const exampleParsed = JSON.parse(exampleJSON) as GeneratedBoxerProfileResponse
