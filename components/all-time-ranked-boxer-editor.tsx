...
const sliderFields: SliderField[] = [
    ...
    { key: "weightClassAlignment", label: "Weight Class Alignment", min: 1, max: 10, step: 1, description: "How naturally aligned the boxer is to the weight class." },
    { key: "handSpeed", label: "Hand Speed", min: 1, max: 10, step: 1, description: "Speed of punches and hand movement." },
    { key: "footSpeed", label: "Foot Speed", min: 1, max: 10, step: 1, description: "Mobility and speed on the feet." },
    { key: "strength", label: "Strength", min: 1, max: 10, step: 1, description: "Raw physical strength." },
    { key: "endurance", label: "Endurance", min: 1, max: 10, step: 1, description: "Ability to sustain performance over rounds." },
    { key: "reactionTime", label: "Reaction Time", min: 1, max: 10, step: 1, description: "How quickly the boxer reacts." },

    { key: "punchAccuracy", label: "Punch Accuracy", min: 1, max: 10, step: 1, description: "How accurately punches land." },
    { key: "punchVariety", label: "Punch Variety", min: 1, max: 10, step: 1, description: "Range of punch selection." },
    { key: "defensiveGuardEfficiency", label: "Defensive Guard Efficiency", min: 1, max: 10, step: 1, description: "Effectiveness of guard and defense." },
    { key: "headMovement", label: "Head Movement", min: 1, max: 10, step: 1, description: "Defensive slipping and upper-body movement." },
    { key: "footworkTechnique", label: "Footwork Technique", min: 1, max: 10, step: 1, description: "Technical quality of movement and positioning." },
    { key: "counterpunchingAbility", label: "Counterpunching Ability", min: 1, max: 10, step: 1, description: "Ability to counter effectively." },
    { key: "combinationEfficiency", label: "Combination Efficiency", min: 1, max: 10, step: 1, description: "How effectively combinations are thrown." },

    { key: "ringIq", label: "Ring IQ", min: 1, max: 10, step: 1, description: "Fight intelligence and awareness." },
    { key: "adaptabilityMidFight", label: "Adaptability Mid-Fight", min: 1, max: 10, step: 1, description: "Ability to adjust during the fight." },
    { key: "distanceControl", label: "Distance Control", min: 1, max: 10, step: 1, description: "Control of range and spacing." },
    { key: "tempoControl", label: "Tempo Control", min: 1, max: 10, step: 1, description: "Ability to control fight pace." },
    { key: "opponentPatternRecognition", label: "Opponent Pattern Recognition", min: 1, max: 10, step: 1, description: "Ability to read opponent tendencies." },
    { key: "fightPlanningDiscipline", label: "Fight Planning Discipline", min: 1, max: 10, step: 1, description: "Commitment to strategy." },

    { key: "composureUnderPressure", label: "Composure Under Pressure", min: 1, max: 10, step: 1, description: "Calmness under stress." },
    { key: "aggressionControl", label: "Aggression Control", min: 1, max: 10, step: 1, description: "Control over offensive pressure." },
    { key: "mentalToughness", label: "Mental Toughness", min: 1, max: 10, step: 1, description: "Mental resilience and grit." },
    { key: "focusConsistency", label: "Focus Consistency", min: 1, max: 10, step: 1, description: "Ability to stay focused throughout." },
    { key: "resilienceAfterKnockdown", label: "Resilience After Knockdown", min: 1, max: 10, step: 1, description: "Recovery and response after adversity." },
    ...
    { key: "titleFightExperience", label: "Title Fight Experience", min: 1, max: 10, step: 1, description: "Experience in title-level fights." },
    { key: "strengthOfOpposition", label: "Strength of Opposition", min: 1, max: 10, step: 1, description: "Quality of opponents faced." },
    { key: "recentFightActivity", label: "Recent Fight Activity", min: 1, max: 10, step: 1, description: "Recency and consistency of activity." },
    { key: "performanceConsistency", label: "Performance Consistency", min: 1, max: 10, step: 1, description: "Consistency of performances over time." },
]
